...
float shadow_calculation(vec4 fragLightPos, sampler2D lightShadMap, vec3 lightDir)
{
...
{
    float shadowDensity = 1.0f - shadow_calculation(fragLightPos, lightShadMap, light.direction);
