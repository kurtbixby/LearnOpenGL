...
size_t SceneLighting::BufferData(GLuint offset)
{
    ...
    for (int i = 0; i < lights_.size(); i++) {
        offset_offset += -offset_offset % STRUCT_ALIGNMENT;
